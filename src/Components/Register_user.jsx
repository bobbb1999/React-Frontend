...
function Register_user() {
  ...
  if (!marketingAccept) {
    ...
    Navigate("/Login");
      // ล้างข้อมูลฟอร์มหลังจากสมัครสมาชิกสำเร็จ (ตามความเหมาะสม)
      // setFormData({
      //   firstname: '',
      //   lastname: '',
      //   email: '',

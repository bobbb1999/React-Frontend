              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-16 mb-16">
                <div data-aos="fade-up" className="aos-init aos-animate">
                  <h1 className="text-xl mb-2">
                    ...
                    <span className="dark:text-gray-200">Pay</span>
                  </h1>
                  <p className="text-xs dark:text-gray-200">
                    ให้ผู้ติดตามของคุณสามารถสนับสนุนคุณได้ง่ายยิ่งขึ้น
                    และรวดเร็วด้วยการรับเงินเข้าบัญชีของคุณไปตรงๆ ทันที
                    ไม่ต้องผ่านตัวกลางใดๆ
                    ด้วยช่องทางการชำระเงินที่เป็นที่นิยมอย่าง TrueMoney หรือ
                    PromptPay
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p className="text-xs dark:text-gray-200">
                    แก้ไข, จัดการ
                    และวิเคราห์การรับเงินโดเนทของคุณได้อย่างง่ายดาย
                    ในหน้าจัดการหลังบ้าน มีช่องทางการรับเงินให้ใช้งานมากมาย
                    และการปรับแต่งหน้ารับเงินอย่างอิสระในแบบของคุณ
                  </p>
                </div>
                <div
                  data-aos="fade-up"
                ...
                >
                  ...
                  <p className="text-xs dark:text-gray-200">
                    ...
                    มีทีมงานคอยซัพพอร์ตตลอด ปลอดภัยทุกการโดเนทแน่นอน
                  </p>
                </div>
              </div>
              {/* <div

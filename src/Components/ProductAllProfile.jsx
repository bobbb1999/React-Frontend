...
function ProductAllProfile() {
  ...
  const categories = [
    ...
    { value: "camera",  label: "กล้องถ่ายรูป/วีดีโอ",  image: "/svg/photo-camera-svgrepo-com.svg",},
    { value: "lens", label: "เลนส์",  image: "/svg/lens-camera-lens-svgrepo-com.svg",},
    { value: "lighting",      label: "ไฟแฟรช/ไฟ LED",      image: "/svg/spotlight-svgrepo-com.svg",},
    { value: "power",      label: "Power/Battery",      image: "/svg/battery-75-svgrepo-com.svg",},
    { value: "gopro", label: "GoPro", image: "/svg/gopro-svgrepo-com.svg" },
    { value: "mic",      label: "Mic/Wireless",      image: "/svg/microphone-svgrepo-com.svg",},
    { value: "accessory_camera",      label: "อุปกรณ์ถ่ายรูป",      image: "/svg/photo-camera-svgrepo-com.svg",},
    { value: "accessory_video",      label: "อุปกรณ์ถ่ายวีดีโอ",      image: "/svg/video-camera-video-svgrepo-com.svg",},
  ];
  ...
  const fetchProducts = async () => {
    try {
      let url = `http://localhost:3001/api/getAllProductsOnProfile/:id`;
      if (selectedCategory) {
...
export default ProductAllProfile;

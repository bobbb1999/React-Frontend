...
function ForrentAll() {
  const [RentProfiles, setRentProfiles] = useState([]);
  ...
  return (
    ...
    // <div>
    //     <h2>Forrent</h2>
    //         <div className="Forrent-profiles">
    //             {RentProfiles.map((profile) => (
